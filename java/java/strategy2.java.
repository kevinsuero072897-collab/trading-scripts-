...
public class UltimateFuturesBotAllStrategies {
    ...
    public static class StrategyRegistry {
        ...
        public void registerAll(IndicatorProcessor indicatorProcessor) {
            ...
            for (int i = 4; i <= 50; i++) {
                strategies.add(new PlaceholderStrategy(indicatorProcessor, "Strategy" + i));
            }
        }
    ...
    public static class PlaceholderStrategy implements StrategyBlueprint {
        private final IndicatorProcessor ip;
        private final String name;

        public PlaceholderStrategy(IndicatorProcessor ip, String name) {
            this.ip = ip;
            this.name = name;
        }
        ...
        public Optional<TradeSignal> evaluate(MarketData data) {
            if (ip.isVolumeSpike(data)) {
                return Optional.of(new TradeSignal(name, data.price, 0.006));
            }
            return Optional.empty();
        }
    }
